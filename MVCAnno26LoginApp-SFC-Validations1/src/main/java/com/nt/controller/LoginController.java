...
public class LoginController {
	...
	/*
	 * @RequestMapping(value="/login.htm",method=RequestMethod.GET) public String
	 * showForm(Map<String,Object> map){ UserCommand cmd=null; cmd=new
	 * UserCommand(); cmd.setUname("raja"); cmd.setPwd("rani"); map.put("userCmd",
	 * cmd); return "login_form"; }
	 */
